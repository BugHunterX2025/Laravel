...
<!-- Mirrored from www.wrraptheme.com/templates/alpino/horizontal/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 May 2025 18:14:16 GMT -->
<head>
<meta charset="utf-8">
...
<title>:: Alpino Horizontal :: Sign In</title>
<!-- Favicon-->
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-12 offset-lg-1">
                    <div class="card-plain">
                        ...
                        <form class="form" action="{{route('loginmatch')}}" method="POST">
                            @csrf
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="Enter Email" name='email'>
                                <span class="input-group-addon"><i class="zmdi zmdi-account-email"></i></span>
                            </div>
                            <div class="input-group">
