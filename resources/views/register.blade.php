...
<!-- Mirrored from www.wrraptheme.com/templates/alpino/horizontal/sign-up.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 May 2025 18:14:53 GMT -->
<head>
<meta charset="utf-8">
...
<title>:: Alpino Horizontal :: Sign Up</title>
<!-- Favicon-->
                    ...
                    <div class="card-plain">
                        ...
                        <form  action="{{route('registersave')}}" method="POST">                            
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" value="{{old('username')}}"placeholder="Enter User Name" name='username'>
